...
cap = cv2.VideoCapture('/Users/aaronraja/Desktop/python/color detection/y2mate.com - Traffic light changing between green yellow and red_1080p.mp4')
...
while True:
    ...
    car_cascade = cv2.CascadeClassifier("3wheelers.xml")
                ...
                if h / s > 50:
                    ...
                    if drawing is False:
                        ...
                        for (x, y, w, h) in cars_ROI:
                            ...
                            name = "D:\\epic PICS" + str(currentframe) + '.jpg'
                            print('creating...' + name)
